...
class MenScreen extends StatelessWidget {
  ...
  const MenScreen({super.key, required this.men});

  Future<List<Product>> fetchMenProducts() async {
    final response = await http.get(Uri.parse("https://fakestoreapi.com/products/category/men's%20clothing"));
